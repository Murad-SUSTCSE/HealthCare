...
export const successfulReset = `
  ...
  <body>
      <div class="container">
          <div class="header">Your password has been successfully reseted!</div>
          <div class="content">
              <p class="welcome-message">Hello {name},</p>
              <p>The password for your HealthCare account was changed. If you didn't change it, you should recover your account.</p>
              <ul>
                  <li>Explore our features and customize your experience.</li>
                  <li>Stay informed by checking out our blog for the latest updates and tips.</li>
                  <li>Reach out to our support team if you have any questions or need assistance.</li>
