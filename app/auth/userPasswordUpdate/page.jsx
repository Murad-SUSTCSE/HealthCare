...
export default function patientPasswordUpdatePage() {
                ...
                <div className="p-8 md:p-12 space-y-8 relative">
                    <header className="space-y-3 text-center">
                        ...
                        <p className="text-sm md:text-base text-teal-800/70 max-w-md mx-auto leading-relaxed">
                            Choose a strong password to keep your patient account secure. Use at least 8 characters with a mix of letters, numbers, and symbols.
                        </p>
                    </header>

                    <form onSubmit={handleSubmit} className="space-y-6">
                        {/* Email comes from previous step (patientReset) via query param */}
                        {email ? (
                        ...
                        {status === 'done' && (
                            <div className="rounded-md border border-teal-300 bg-teal-50 text-teal-800 px-4 py-3 text-sm animate-fade-in">
                                ...
                                <Link href="/auth/patient/login" className="underline font-semibold hover:text-teal-900">log in</Link> with your new password.
                            </div>
                        )}
